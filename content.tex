\begin{frame}{Bijections}
  ...
  \begin{center}
    \begin{tikzpicture}[ele/.style={fill=black,circle,minimum width=.8pt,inner sep=1pt},every fit/.style={ellipse,draw,inner sep=-2pt}, >=latex]
      ...
      \path[->, shorten <=2pt, shorten >=2pt] (a1) edge node[above] {$f$} (b1);
      \draw[->, shorten <=2pt, shorten >=2pt] (a2) edge node[above] {$f$} (b2);
      \draw[->, shorten <=2pt, shorten >=2pt] (a3) edge node[above] {$f$} (b3);
      \draw[->, shorten <=2pt, shorten >=2pt] (a4) edge node[above] {$f$} (b4);  
    \end{tikzpicture} 
  \end{center}
